...
<div class="container">
<div class="col-sm-12">
<form class="well form-horizontal" action="admin_registration_process.php" method="post"  id="registration_form">
		<fieldset>

			<!-- Form Name -->
			<legend><center><h2><b>Admin Registration Form</b></h2></center></legend><br>
